...
,nh_("~")
,serial_()
,serial_timeout_(serial::Timeout::simpleTimeout(500))
,pub_imu_raw_(nh_.advertise<sensor_msgs::Imu>("imu_raw",1,false))
,pub_imu_(nh_.advertise<sensor_msgs::Imu>("imu",1,false))
